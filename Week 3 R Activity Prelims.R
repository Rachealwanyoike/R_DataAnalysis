...
Just_Height<-(mywomen$height)
Just_Weight<-(mywomen$weight)

#This takes the individual objects ('values' in the Environment) and creates a dataframe
#I can see the Data in the Environment 
#Task: Write the function to create a data.frame from the height and weight values you just create

newwomen<- data.frame(Just_Height, Just_Weight)
...
subset(newwomen,Just_Height>65)
